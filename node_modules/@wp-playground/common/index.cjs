"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const a=require("@php-wasm/util");function f(i=fetch){const e={};return async function(t,r){if(!e[t]){e[t]={responsePromise:i(t,r),async nextResponse(){const n=await e[t].responsePromise,[c,$]=e[t].unlockedBodyStream.tee();return e[t].unlockedBodyStream=c,new Response($,{status:n.status,statusText:n.statusText,headers:n.headers})}};const s=await e[t].responsePromise;e[t].unlockedBodyStream=s.body}return e[t].nextResponse()}}const l="8.3",p=async(i,e,o,t=!0)=>{const r=`/tmp/file-${Math.random()}.zip`;if(e instanceof File){const n=e;e=r,await i.writeFile(e,new Uint8Array(await n.arrayBuffer()))}const s=a.phpVars({zipPath:e,extractToPath:o,overwriteFiles:t});await i.run({code:`<?php
